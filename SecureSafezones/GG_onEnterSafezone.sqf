...
// Delete Bicycles in Safezones
_playersVehicle = vehicle player;
if ((typeOf (_playersVehicle)) == "Exile_Bike_OldBike" OR (typeOf (_playersVehicle)) == "Exile_Bike_MountainBike") then { deleteVehicle _playersVehicle };
